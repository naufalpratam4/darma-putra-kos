@extends('layouts.jadwalTemu')
@section('content')
    <div class="container flex mx-auto mt-4">
        <div class="mx-auto font-semibold text-4xl">Jadwalkan untuk ketemu tanya secara langsung</div>
    </div>


    <form action="{{ route('jadwalKetemu') }}" method="POST">
        @csrf
        <div class="container  md:px-0 px-5 md:mx-auto  grid md:grid-cols-2 gap-5 mt-10">
            ...
            <div class="mb-5">
                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Apa
                    keperluanmu</label>
                <input type="text" id="base-input" name="keperluan" required
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            <div class="mb-5">
        ...
        <div class="flex justify-end container mx-auto">
            <button type="submit"
                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5  mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Kirim</button>
        </div>
    </form>
